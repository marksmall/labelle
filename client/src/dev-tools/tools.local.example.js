...
// Like you could use React Testing Library to fill out the username add
// password on load:
...
// in the past I'd also have a history listener that would automatically
// execute code when I navigated to a specific path (to auto-fill a large
// form I was working on).

// This is an optional component I can export to add a tool to the DevTools UI
const Default = () => <div>Local dev tools!</div>;
